...
create table if not exists public.health_events (
  ...
  event_kind text not null check (event_kind in ('meal', 'symptom', 'bowel', 'urine', 'stress', 'tea', 'medication', 'water', 'weight', 'sleep', 'exercise', 'note')),
...
with check (bucket_id = 'medical-exams' and owner_id = (select auth.jwt()->>'sub'));
