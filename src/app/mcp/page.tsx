...
export default function McpConnectionPage() {
  ...
  return <main className="min-h-screen bg-[#f9f7f3] text-[#2c2c2c]"><div className="mx-auto max-w-2xl px-5 pb-12 sm:px-8">
    ...
    <section className="mt-5 rounded-3xl border border-[#e8f5f2] bg-white p-5 shadow-sm"><h2 className="text-lg font-bold">O que fica disponível</h2><div className="mt-3 grid gap-2 sm:grid-cols-2"><div className="rounded-2xl bg-[#f7faf7] p-3 text-sm text-[#527063]">📅 Eventos por dia</div><div className="rounded-2xl bg-[#f7faf7] p-3 text-sm text-[#527063]">✦ Resumos salvos</div><div className="rounded-2xl bg-[#f7faf7] p-3 text-sm text-[#527063]">▣ Relatórios por período</div><div className="rounded-2xl bg-[#f7faf7] p-3 text-sm text-[#527063]">📄 Exames anexados</div><div className="rounded-2xl bg-[#f7faf7] p-3 text-sm text-[#527063]">📝 Histórico intestinal</div></div><p className="mt-4 text-xs leading-relaxed text-[#819189]">A conexão é somente leitura. O MCP não cria, edita ou exclui registros. Cada usuário acessa exclusivamente os próprios dados.</p></section>
