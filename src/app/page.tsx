...
function LandingPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#fcfcf9] text-[#18342b]">
      ...
      <section id="recursos" className="border-y border-[#e8eee8] bg-white px-5 py-16 sm:px-8"><div className="mx-auto max-w-6xl"><div className="max-w-xl"><p className="text-sm font-semibold text-[#39734f]">Feito para a vida real</p><h2 className="mt-2 text-3xl font-semibold tracking-tight">Um diário leve, com o que realmente importa.</h2><p className="mt-3 leading-relaxed text-[#698076]">Registre o seu dia sem complicação e transforme informações soltas em uma visão clara da sua rotina.</p></div><div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-5"><Feature icon="⚡" title="Registro rápido" text="Adicione um evento em poucos segundos, sem formulários enormes." /><Feature icon="◷" title="Linha do tempo" text="Veja o que aconteceu antes e depois de cada sintoma." /><Feature icon="✦" title="Análise por IA" text="Avalie o dia completo e encontre associações observadas nos seus próprios registros." /><Feature icon="🔒" title="Memória individual" text="Seu histórico e suas análises ficam separados por usuário." /><Feature icon="◈" title="MCP + Claude" text="Conecte seu diário ao Claude para consultar eventos e relatórios, sempre com sua autorização." /></div></div></section>
      <section id="como-funciona" className="px-5 py-16 sm:px-8"><div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center"><div><p className="text-sm font-semibold text-[#39734f]">Do registro ao entendimento</p><h2 className="mt-2 text-3xl font-semibold tracking-tight">Mais clareza para conversar sobre a sua saúde.</h2><p className="mt-4 leading-relaxed text-[#698076]">O Meuintestino organiza alimentação, evacuações, sintomas, hidratação, sono, medicamentos e atividades em um único lugar.</p><Link href="/login" className="mt-7 inline-flex rounded-2xl bg-[#1e6341] px-5 py-3 font-semibold text-white shadow-[0_10px_24px_rgba(30,99,65,0.2)]">Começar meu diário</Link></div><div className="grid gap-3 sm:grid-cols-3"><Step number="01" title="Registre" text="Anote o que aconteceu, no seu ritmo." /><Step number="02" title="Observe" text="Veja sua linha do tempo e seus padrões." /><Step number="03" title="Compartilhe" text="Use o MCP para consultar seus dados no Claude." /></div></div></section>
