...
export default function ProfilePage() {
  ...
  return <main className="min-h-screen bg-[#f9f7f3] text-[#2c2c2c]"><div className="mx-auto max-w-3xl px-5 pb-12 sm:px-8">
    ...
    <Link href="/categories" className="mt-5 flex items-center justify-between rounded-3xl border border-[#cfe8df] bg-[#e8f5f2] p-5"><span><span className="block text-xs font-bold uppercase tracking-[0.16em] text-[#1b8b6f]">Personalização</span><span className="mt-1 block text-sm font-semibold text-[#245443]">Gerenciar categorias e listas</span></span><span className="text-xl text-[#39734f]">›</span></Link>
